...
[![testes](https://img.shields.io/badge/testes-1838-brightgreen)](tests/run.sh)
...
| `tandem instantaneo` · `tandem desfazer` | tira uma cópia do ambiente Wine e desfaz uma instalação ruim |
